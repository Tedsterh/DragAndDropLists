...
class DragAndDropPageWrapper extends StatefulWidget {
  ...
  DragAndDropPageWrapper({Key key, this.dragAndDropPageInterface, this.parameters, @required this.scrollController}) : super(key: key);
...
class _DragAndDropPageWrapperState extends State<DragAndDropPageWrapper> {
  ...
  Widget build(BuildContext context) {
    Widget dragAndDropPageContents = widget.dragAndDropPageInterface.generateWidget(widget.parameters, widget.scrollController);
